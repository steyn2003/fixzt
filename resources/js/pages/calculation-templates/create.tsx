...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nieuwe Template', href: '/dashboard/calculation-templates/create' },
];

export default function CalculationTemplateCreate() {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <Card className="max-w-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Maak een nieuwe calculatie template aan
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
