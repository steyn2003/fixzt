...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nieuwe Calculatie', href: '/dashboard/calculations/create' },
];
...
export default function CalculationCreate({ clients, locations, templates }: Props) {
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        notes: '',
        valid_until: '',
        lines: [{ ...defaultLine }] as Omit<CalculationLine, 'id' | 'calculation_id'>[],
    });
                ...
                <div className="flex h-full flex-1 flex-col gap-4 p-4">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Maak een nieuwe calculatie aan
                            </CardDescription>
                        </CardHeader>
                    ...
                    <div className="flex gap-4">
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Opslaan...' : 'Calculatie Aanmaken'}
                        </Button>
