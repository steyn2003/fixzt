...
export default function LocationEdit({ location, clients }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Bewerken', href: `/dashboard/locations/${location.id}/edit` },
    ];

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/dashboard/locations/${location.id}`);
    };
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <Card className="max-w-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Pas de gegevens van {location.name} aan
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
